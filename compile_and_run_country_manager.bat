...
echo Running Country Manager...
"%JAVA_HOME%\bin\java.exe" --module-path "%JAVAFX_HOME%\lib" --add-modules javafx.controls --add-opens javafx.graphics/com.sun.glass.utils=ALL-UNNAMED --add-opens javafx.graphics/com.sun.marlin=ALL-UNNAMED -cp "out;lib\*" tournament.scheduler.masterdata.CountryManagerGUI
